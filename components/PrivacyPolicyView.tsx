    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <section className="panel-platinum">
        ...
        <p className="text-ctj-silver mt-3 leading-relaxed">
          Part 1 responses, checkpoint reflections, completion progress, final reflection, and display settings are stored in browser LocalStorage. This local version has no account backend, cloud journal storage, analytics, or external AI model connection.
        </p>
      </section>
