    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <section className="panel-platinum">
        ...
        <p className="text-ctj-silver mt-3 leading-relaxed">
          Part 1 responses, checkpoint reflections, completion progress, final reflection, and display settings are stored in browser LocalStorage. This candidate runtime has no account backend, cloud journal storage, analytics, or external AI model connection.
        </p>
      </section>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <Policy icon={<Trash2 />} title="Delete control">Reset All Data clears Part 1 data and settings stored by this application in the current browser.</Policy>
      </div>
      ...
      <section className="panel-dark">
        <div className="flex gap-3">
          ...
          <p className="text-sm text-ctj-silver">
            Part 1 is an educational and reflective product. It does not provide medical, psychological, legal, financial, or other licensed professional advice.
          </p>
        </div>
      </section>
    </div>
