...
export const UserGuideView: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <div>
        <p className="text-xs uppercase tracking-[0.22em] text-ctj-gold">Part 1</p>
        <h1 className="text-4xl font-semibold mt-2">User Guide</h1>
        <p className="text-ctj-silver mt-3 max-w-2xl">
          Part 1 is a ten-day reasoning practice. The core curriculum remains structured, but each day now distinguishes required core work from optional deeper work.
        </p>
      </div>
