  ...
  return (
    <div className="space-y-10 py-8 sm:py-14 animate-fade-in">
      <div className="text-center max-w-4xl mx-auto space-y-4">
        <p className="text-xs sm:text-sm font-semibold tracking-[0.26em] uppercase text-ctj-gold">The Critical Thinker's Journey™ · Part 1</p>
        <h1 className="text-4xl sm:text-6xl font-semibold tracking-tight">Building Clarity and Confidence</h1>
        <p className="text-xl text-ctj-silver">Foundation · Logic · Evidence · Bias · Better questions</p>
      </div>

      <section className="panel-platinum max-w-3xl mx-auto space-y-5">
        <p className="text-lg text-ctj-silver leading-relaxed">
          Part 1 builds the foundation for clearer reasoning. Across ten days, you will make claims more explicit, separate fact from assumption, examine premises, and practice recognizing common biases and fallacies.
        </p>
      ...
      <section className="grid md:grid-cols-2 gap-4 max-w-4xl mx-auto">
        <div className="panel-dark">
          ...
          <h2 className="text-xl font-semibold mt-2">Foundations of Logic</h2>
        ...
        <div className="panel-dark">
          ...
          <h2 className="text-xl font-semibold mt-2">Bias & Fallacies</h2>
          <p className="text-sm text-ctj-muted mt-2">Bias, confirmation bias, availability, ad hominem, straw man reasoning, false dilemmas, and red herrings.</p>
        </div>
      </section>

      <div className="max-w-xl mx-auto">
        <button
          data-testid="begin-part1"
          onClick={() => dispatch({ type: 'SET_DAY_INDEX', payload: targetIndex })}
          className="btn-primary w-full inline-flex items-center justify-center gap-2"
        >
          {started ? 'Continue Part 1' : 'Begin Part 1'} <ArrowRight size={18} />
        </button>
