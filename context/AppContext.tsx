...
import { AppAction, AppSettings, Part1State } from '../types';
...
function sanitizeState(value: unknown): Partial<Part1State> {
  if (!value || typeof value !== 'object') return {};
  const raw = value as Partial<Part1State>;
...
function reducer(state: Part1State, action: AppAction): Part1State {
  switch (action.type) {
    case 'SET_VIEW':
